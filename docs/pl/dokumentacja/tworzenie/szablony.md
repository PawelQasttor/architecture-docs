...
Szablony do kopiowania dla wszystkich typów kart SBM. Zastąp wartości zastępcze danymi swojego projektu.

## Szablon Przestrzeni {#space}
...
spaceType: "sleeping_space"  # Zobacz dokumentację kart dla pełnej listy enum
buildingId: "BLD-01"
levelId: "LVL-01"
...
## Szablon Urządzenia {#asset-instance}
...
assetType: "ahu"  # Zobacz dokumentację kart dla pełnej listy
...
buildingType: "residential_multifamily"  # Zobacz dokumentację kart dla pełnej listy enum
...
climateZone: "Dfb"  # Klasyfikacja Koppena
grossFloorArea: 4850
numberOfLevels: 4
numberOfUnits: 32
...
## Wskazówki dotyczące korzystania z szablonów

### 1. Zacznij minimalnie, dodawaj szczegóły później

Zacznij od minimalnego szablonu, skompiluj aby upewnić się, że struktura jest poprawna, a następnie dodawaj opcjonalne pola.

```bash
# Krok 1: Utwórz minimalną kartę
vim spaces/bedroom-01.md  # Użyj minimalnego szablonu

# Krok 2: Zwaliduj strukturę
node scripts/compiler/index.mjs compile --validate-only

# Krok 3: Dodaj opcjonalne pola
vim spaces/bedroom-01.md  # Dodaj designArea, requirements, itd.
```

### 2. Kopiuj istniejące karty

Najszybszy sposób tworzenia podobnych kart:

```bash
# Skopiuj bedroom-01 do bedroom-02
...
### 3. Używaj snippetów w edytorze

Utwórz snippety w VS Code dla szybszego tworzenia:
...
- **[Tworzenie kart](/pl/dokumentacja/tworzenie/tworzenie-encji)** - Przewodniki krok po kroku
