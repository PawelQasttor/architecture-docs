...
# Standardowa sypialnia typ A

Ten typ przestrzeni definiuje standardowy układ sypialni stosowany w całym projekcie mieszkalnym Green Terrace. Wszystkie instancje sypialni odwołują się do tego szablonu typu i dziedziczą jego specyfikacje, chyba że zostaną jawnie nadpisane.
