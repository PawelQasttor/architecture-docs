...
regulatoryCompliance:
  - regulation: "WT 2021"
    section: "§ 328"
    requirement: "U ≤ 0,20 W/(m²·K) dla ścian zewnętrznych"
    status: "compliant"
  - regulation: "WT 2021"
    section: "§ 234"
    requirement: "REI 60 dla wysokości budynku 18,5 m"
    status: "compliant"
  - regulation: "PN-B-02151"
    section: "-"
    requirement: "Rw ≥ 50 dB dla ścian zewnętrznych"
    status: "compliant"
...
Nośna ściana zewnętrzna z wentylowaną szczeliną powietrzną, stosowana na wszystkich elewacjach Budynku 01 (Green Terrace).

## Podsumowanie układu warstw

- **Całkowita grubość:** 447,5 mm
- **5 warstw:** tynk mineralny + bloczki z betonu komórkowego + izolacja XPS + szczelina powietrzna + płyta gipsowo-kartonowa
- **Współczynnik U:** 0,18 W/(m²·K) (wymagany ≤ 0,20)
- **Odporność ogniowa:** REI 90 (wymagana REI 60)
- **Izolacyjność akustyczna:** Rw 55 dB (wymagana ≥ 50 dB)

## Zgodność z przepisami

Wszystkie kontrole regulacyjne spełnione: cieplna (WT § 328), ogniowa (WT § 234), akustyczna (PN-B-02151) oraz wilgotnościowa (PN-EN ISO 13788).

## Koszt

Całkowity szacunkowy koszt: 192 544 EUR (155 EUR/m² powierzchni brutto). Obejmuje mur, izolację, tynk, wykończenie wewnętrzne, nadproża oraz 5% rezerwy.
