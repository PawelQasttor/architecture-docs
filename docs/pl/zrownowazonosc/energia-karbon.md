...
1. **[Projekt budowlany](/pl/fazy/projekt-budowlany)** — architekt oblicza wstępny EP na podstawie dokumentacji
2. **Budowa** — wykonawca realizuje obiekt zgodnie ze specyfikacją; zmiany dokumentowane w modelu as-built
3. **[Przekazanie](/pl/fazy/eksploatacja)** — osoba uprawniona sporządza świadectwo na podstawie stanu faktycznego
...
| Współczynnik U przegród | Budynek / Wymaganie | `zrownowazonosc.przegrody.sciana_u` | [Projekt wstępny](/pl/fazy/projekt-wstepny) |
| Źródło energii | Instalacja | `zrodlo_energii`, `udzial_oze` | [Projekt budowlany](/pl/fazy/projekt-budowlany) |
| Szczelność n50 | Budynek | `zrownowazonosc.przegrody.szczelnosc_n50` | [Projekt wykonawczy](/pl/fazy/projekt-wykonawczy) |
| Ślad węglowy (kgCO₂e/m²) | Budynek | `zrownowazonosc.weglowy.cel_embodied` | [Projekt budowlany](/pl/fazy/projekt-budowlany) |
| Klasa energetyczna (A–G) | Budynek | `klasa_energetyczna` | [Przekazanie](/pl/fazy/eksploatacja) |
| Sprawność odzysku ciepła | Instalacja | `sprawnosc_odzysku` | [Projekt budowlany](/pl/fazy/projekt-budowlany) |
